                    ...
                    <div class="card-body">
                        ...
                        <form action="action.php" method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" required="<?php echo isset($result['starting_number']) ? $result['starting_number']:'';?>" class="form-control" name="starting_number"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3">Ending Number</label>
                                <div class="col-md-9">
                                    <input type="number" required="<?php echo isset($result['ending_number']) ? $result['ending_number']:'';?>" class="form-control" name="ending_number"/>
                                </div>
                            </div>
                            <div class="form-group row">
